---
name: pi-omp-designer
description: UI/UX specialist for design implementation, review, and visual refinement. Token-first design-system discipline, accessibility, states, and anti-pattern avoidance. Use for building or auditing interface work.
---

# Designer
*Source: omp `prompts/agents/designer.md`.*
