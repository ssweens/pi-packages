import type { AgentCapabilities, AnyMessage, McpServer, RequestPermissionRequest, SessionNotification, SessionConfigOption, SessionInfo, SetSessionConfigOptionResponse, StopReason, ToolKind } from "@agentclientprotocol/sdk";
...
export declare const EXIT_CODES: {
    ...
    readonly USAGE: 2;
    readonly TIMEOUT: 3;
    readonly NO_SESSION: 4;
    readonly PERMISSION_DENIED: 5;
    readonly INTERRUPTED: 130;
};
export type ExitCode = (typeof EXIT_CODES)[keyof typeof EXIT_CODES];
export declare const OUTPUT_FORMATS: readonly ["text", "json", "quiet"];
export type OutputFormat = (typeof OUTPUT_FORMATS)[number];
export declare const PERMISSION_MODES: readonly ["approve-all", "approve-reads", "deny-all"];
export type PermissionMode = (typeof PERMISSION_MODES)[number];
export declare const AUTH_POLICIES: readonly ["skip", "fail"];
export type AuthPolicy = (typeof AUTH_POLICIES)[number];
export declare const NON_INTERACTIVE_PERMISSION_POLICIES: readonly ["deny", "fail"];
export type NonInteractivePermissionPolicy = (typeof NON_INTERACTIVE_PERMISSION_POLICIES)[number];
export declare const PERMISSION_POLICY_ACTIONS: readonly ["approve", "deny", "escalate"];
...
export declare const SESSION_RESUME_POLICIES: readonly ["allow-new", "same-session-only"];
export type SessionResumePolicy = (typeof SESSION_RESUME_POLICIES)[number];
export declare const OUTPUT_STREAMS: readonly ["prompt", "control"];
...
export declare const OUTPUT_ERROR_CODES: readonly ["NO_SESSION", "TIMEOUT", "PERMISSION_DENIED", "PERMISSION_PROMPT_UNAVAILABLE", "RUNTIME", "USAGE"];
export type OutputErrorCode = (typeof OUTPUT_ERROR_CODES)[number];
export declare const OUTPUT_ERROR_ORIGINS: readonly ["cli", "runtime", "queue", "acp"];
export type OutputErrorOrigin = (typeof OUTPUT_ERROR_ORIGINS)[number];
export declare const QUEUE_ERROR_DETAIL_CODES: readonly ["QUEUE_OWNER_CLOSED", "QUEUE_OWNER_SHUTTING_DOWN", "QUEUE_OWNER_OVERLOADED", "QUEUE_OWNER_GENERATION_MISMATCH", "QUEUE_REQUEST_INVALID", "QUEUE_REQUEST_PAYLOAD_INVALID_JSON", "QUEUE_ACK_MISSING", "QUEUE_DISCONNECTED_BEFORE_ACK", "QUEUE_DISCONNECTED_BEFORE_COMPLETION", "QUEUE_PROTOCOL_INVALID_JSON", "QUEUE_PROTOCOL_MALFORMED_MESSAGE", "QUEUE_PROTOCOL_UNEXPECTED_RESPONSE", "QUEUE_NOT_ACCEPTING_REQUESTS", "QUEUE_CONTROL_REQUEST_FAILED", "QUEUE_RUNTIME_PROMPT_FAILED"];
...
export type ClientOperationMethod = "fs/read_text_file" | "fs/write_text_file" | "terminal/create" | "terminal/output" | "terminal/wait_for_exit" | "terminal/kill" | "terminal/release";
...
export declare const SESSION_RECORD_SCHEMA: "acpx.session.v1";
