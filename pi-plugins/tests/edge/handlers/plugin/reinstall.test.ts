...
import { GENERATED_AGENT_PREFIX } from "../../../../extensions/pi-plugins/bridges/agents/marker.ts";
import { pathSource } from "../../../../extensions/pi-plugins/domain/source.ts";
import { makeReinstallHandler } from "../../../../extensions/pi-plugins/edge/handlers/plugin/reinstall.ts";
import { installPlugin } from "../../../../extensions/pi-plugins/orchestrators/plugin/install.ts";
...
import { __resetCacheForTests } from "../../../../extensions/pi-plugins/shared/completion-cache.ts";

import type { Scope } from "../../../../extensions/pi-plugins/shared/types.ts";
