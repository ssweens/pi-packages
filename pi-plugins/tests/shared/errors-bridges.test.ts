...
} from "../../extensions/pi-plugins/shared/errors-bridges.ts";
import { PathContainmentError } from "../../extensions/pi-plugins/shared/path-safety.ts";
...
test("AG-9/RN-4 AgentOwnershipConflictError formats single-conflict message", () => {
  ...
  assert.match(err.message, /"pi-plugins-acme-bot" already owned by official\/old-acme/);
