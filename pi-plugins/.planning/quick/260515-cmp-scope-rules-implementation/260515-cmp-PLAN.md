...
1. **Plugin lifecycle scope resolution**
   - Files: `extensions/pi-plugins/orchestrators/plugin/*.ts`, `extensions/pi-plugins/edge/handlers/plugin/*.ts`
...
2. **Scope-aware completion filtering**
   - Files: `extensions/pi-plugins/edge/completions/*.ts`, `extensions/pi-plugins/orchestrators/edge-deps.ts`
