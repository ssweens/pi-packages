...
[VERIFIED: source read -- extensions/pi-plugins/bridges/agents/convert.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/bridges/agents/frontmatter.ts lines 137, 190]
...
[VERIFIED: source read -- extensions/pi-plugins/bridges/agents/types.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/bridges/agents/stage.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/orchestrators/plugin/install.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/orchestrators/plugin/update.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/edge/handlers/plugin/install.ts, edge/handlers/plugin/list.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/edge/handlers/plugin/update.ts]
...
[VERIFIED: source read -- extensions/pi-plugins/edge/args.ts]
...
[VERIFIED: source read -- docs/prd/pi-plugins-prd.md lines 245, 280, 415-417]
...
```typescript
// Source: extensions/pi-plugins/edge/handlers/plugin/list.ts lines 29-54
let parsed;
try {
...
[VERIFIED: source read -- extensions/pi-plugins/edge/handlers/plugin/list.ts]
...
```typescript
// Source: extensions/pi-plugins/bridges/agents/convert.ts line 400-402
...
- Source code read: `extensions/pi-plugins/bridges/agents/convert.ts` -- model
  mapping pipeline, `mapModel` function, `convertAgent`, `optionalModel` helper
- Source code read: `extensions/pi-plugins/bridges/agents/frontmatter.ts` --
  `GeneratedFrontmatterFields.model?: string`, conditional emit guard
- Source code read: `extensions/pi-plugins/bridges/agents/types.ts` --
  `StageAgentsInput`, `ConvertedAgent`
- Source code read: `extensions/pi-plugins/bridges/agents/stage.ts` --
  `prepareStagePluginAgents`, `convertAgent` call site
- Source code read: `extensions/pi-plugins/orchestrators/plugin/install.ts` --
  `InstallPluginOptions`, agents phase call to `prepareStagePluginAgents`
- Source code read: `extensions/pi-plugins/orchestrators/plugin/update.ts` --
  `UpdatePluginsOptions`, `ThreePhaseArgs`, `prepareUpdateHandles`, `updateSinglePlugin`
- Source code read: `extensions/pi-plugins/edge/handlers/plugin/install.ts` --
  current handler pattern using `parseRequiredPluginMarketplaceRef`
- Source code read: `extensions/pi-plugins/edge/handlers/plugin/update.ts` --
  current handler using `parseCommandArgs`
- Source code read: `extensions/pi-plugins/edge/handlers/plugin/list.ts` --
  boolean flag pattern (`BOOLEAN_FLAGS`, positional scan loop)
- Source code read: `extensions/pi-plugins/edge/args.ts` -- tokenizer, `--scope`
  is the only specially handled flag
- Source code read: `docs/prd/pi-plugins-prd.md` -- AG-7 detail (line 417),
