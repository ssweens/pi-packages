...
patterns-established:
  - "Pattern A: Output discipline via flat-config files-glob + no-restricted-syntax + no-console=error scoped to extensions/pi-plugins/**/*.ts"
...
- ✓ exactly 9 `target: "./extensions/pi-plugins/...` zones (9)
