...
```bash
rg "process\.stdout|process\.stderr|console\.log|console\.error" extensions/pi-plugins/orchestrators/import extensions/pi-plugins/edge
rg "installPlugin\(" extensions/pi-plugins/orchestrators/import/execute.ts
rg "addMarketplace\(" extensions/pi-plugins/orchestrators/import/execute.ts
rg "import" extensions/pi-plugins/edge/router.ts extensions/pi-plugins/edge/completions/provider.ts extensions/pi-plugins/edge/register.ts
```
