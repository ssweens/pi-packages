...
key-files:
  created:
    - extensions/pi-plugins/edge/handlers/plugin/import.ts
...
- `extensions/pi-plugins/edge/handlers/plugin/import.ts` - Thin import edge handler.
- `extensions/pi-plugins/edge/router.ts` - Top-level import usage and dispatch.
- `extensions/pi-plugins/edge/completions/provider.ts` - Top-level `import` completion.
- `extensions/pi-plugins/edge/register.ts` - Import handler registration.
- `extensions/pi-plugins/edge/types.ts` - Optional import orchestrator test seam.
