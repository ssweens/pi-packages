...
- `extensions/pi-plugins/orchestrators/import/execute.ts` - Lint-only validation closeout adjustments for the audited import flow.
- `extensions/pi-plugins/orchestrators/plugin/install.ts` - Lint-only validation closeout adjustment.
...
- `rg "process\\.stdout|process\\.stderr|console\\.log|console\\.error" extensions/pi-plugins/orchestrators/import extensions/pi-plugins/edge` - no matches.
