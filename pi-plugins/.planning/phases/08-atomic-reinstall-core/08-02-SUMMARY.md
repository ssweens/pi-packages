...
- `extensions/pi-plugins/bridges/skills/types.ts` - Adds opaque `SkillsReplacement` public handle types.
- `extensions/pi-plugins/bridges/skills/stage.ts` - Adds replace/rollback/finalize helpers with backup and manual-recovery leak reporting.
- `extensions/pi-plugins/bridges/skills/index.ts` - Exports new skills replacement helpers and type.
- `tests/bridges/skills/stage.test.ts` - Adds rollback/finalize/noop/conflict tests for skills replacement.
- `extensions/pi-plugins/bridges/commands/types.ts` - Adds opaque `CommandsReplacement` public handle types.
- `extensions/pi-plugins/bridges/commands/stage.ts` - Adds replace/rollback/finalize helpers with backup and manual-recovery leak reporting.
- `extensions/pi-plugins/bridges/commands/index.ts` - Exports new commands replacement helpers and type.
