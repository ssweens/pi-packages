...
| Option | Description | Selected |
| ------ | ----------- | -------- |
| Delete and leave absent | Reinstall is a reset: remove `<scopeRoot>/pi-plugins/data/<marketplace>/<plugin>/` after successful replacement. Future plugin code can recreate it if needed. | ✓ |
