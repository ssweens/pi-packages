...
- `extensions/pi-plugins/orchestrators/discover.ts` - Pure disk-backed resources discovery aggregator for Pi reloads.
- `extensions/pi-plugins/shared/errors.ts` - Adds `AggregateResourcesDiscoverError` and structured failure metadata.
- `extensions/pi-plugins/index.ts` - Real Pi extension entrypoint wiring command, tools, and discovery.
...
- **Files modified:** `extensions/pi-plugins/index.ts`
...
- Found `extensions/pi-plugins/orchestrators/discover.ts`.
