...
provides:
  - Single Pi API wrapper at extensions/pi-plugins/platform/pi-api.ts
...
key-files:
  ...
  modified:
    ...
    - extensions/pi-plugins/**/handlers and orchestrator type imports
...
- Created the sole production Pi API import surface at `extensions/pi-plugins/platform/pi-api.ts`.
...
- `extensions/pi-plugins/platform/pi-api.ts` - Thin Pi API type wrapper plus soft-dependency helpers.
- `extensions/pi-plugins/presentation/soft-dep.ts` - Compatibility shim re-exporting platform helpers.
...
- `extensions/pi-plugins/**` - Migrated direct Pi peer type imports to relative `platform/pi-api.ts` imports.
...
- **Files modified:** `extensions/pi-plugins/platform/pi-api.ts`
...
- Found `extensions/pi-plugins/platform/pi-api.ts`.
