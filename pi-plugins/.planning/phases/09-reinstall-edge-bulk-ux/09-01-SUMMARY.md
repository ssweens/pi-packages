...
- `extensions/pi-plugins/orchestrators/plugin/reinstall.ts` - quiet render seam, bulk target enumeration, sequential batch execution, and deterministic batch rendering.
- `extensions/pi-plugins/orchestrators/plugin/index.ts` - exports `reinstallPlugins` and its option/target types.
- `extensions/pi-plugins/orchestrators/index.ts` - re-exports the bulk reinstall API at the top-level orchestrator surface.
