...
- `extensions/pi-plugins/edge/completions/data.ts` - adds reinstall completion mode and opt-in boolean flag positional skipping.
- `extensions/pi-plugins/edge/completions/provider.ts` - adds top-level reinstall, reinstall-only `--force`, marketplace-only target completions, and shared plugin-ref completion config.
...
- **Files modified:** `extensions/pi-plugins/edge/completions/provider.ts`
...
- `pre-commit run --files extensions/pi-plugins/edge/completions/data.ts extensions/pi-plugins/edge/completions/provider.ts tests/edge/completions/provider.test.ts` passed.
