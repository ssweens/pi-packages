...
dependency_graph:
  requires:
    - extensions/pi-plugins/persistence/locations.ts (commandsStagingDir, promptsTargetDir, ScopedLocations)
    - extensions/pi-plugins/domain/name.ts (assertSafeName, generatedCommandName)
    - extensions/pi-plugins/domain/resolver.ts (ResolvedPluginInstallable + componentPaths.commands)
...
key-files:
  created:
    - extensions/pi-plugins/bridges/commands/types.ts
    - extensions/pi-plugins/bridges/commands/discover.ts
    - extensions/pi-plugins/bridges/commands/stage.ts
    - extensions/pi-plugins/bridges/commands/unstage.ts
    - extensions/pi-plugins/bridges/commands/index.ts
...
**`extensions/pi-plugins/bridges/commands/types.ts`** (new)
...
**`extensions/pi-plugins/bridges/commands/discover.ts`** (new)
...
**`extensions/pi-plugins/bridges/commands/stage.ts`** (new)
...
**`extensions/pi-plugins/bridges/commands/unstage.ts`** (new)
...
**`extensions/pi-plugins/bridges/commands/index.ts`** (new)
...
- **Files modified:** `extensions/pi-plugins/bridges/commands/discover.ts`.
- **Commit:** `5abb656`.
...
- **Files modified:** `extensions/pi-plugins/bridges/commands/index.ts`.
- **Commit:** `8d459d4`.
...
- `npx eslint extensions/pi-plugins/bridges/commands/ tests/bridges/commands/` exit 0.
