...
key-files:
  created:
    - extensions/pi-plugins/bridges/agents/types.ts
    - extensions/pi-plugins/bridges/agents/marker.ts
    - extensions/pi-plugins/bridges/agents/frontmatter.ts
    - extensions/pi-plugins/bridges/agents/convert.ts
    - extensions/pi-plugins/bridges/agents/discover.ts
    - extensions/pi-plugins/bridges/agents/index-mutation.ts
    - extensions/pi-plugins/bridges/agents/stage.ts
    - extensions/pi-plugins/bridges/agents/unstage.ts
...
- AG-5 two-part marker check enforced (basename prefix `pi-plugins-` AND body marker `generated by pi-plugins`)
...
### Source modules (extensions/pi-plugins/bridges/agents/)
...
`extensions/pi-plugins/bridges/agents/convert.ts` line ~358 calls
...
Verified post-write:
- `extensions/pi-plugins/bridges/agents/types.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/marker.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/frontmatter.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/convert.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/discover.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/index-mutation.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/stage.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/unstage.ts` exists ✓
- `extensions/pi-plugins/bridges/agents/index.ts` exists ✓
...
- `npx eslint extensions/pi-plugins/bridges/agents/ tests/bridges/agents/` exits 0 ✓
- `npx prettier --check extensions/pi-plugins/bridges/agents/ tests/bridges/agents/` exits 0 ✓
