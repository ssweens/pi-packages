...
dependency_graph:
  requires:
    - extensions/pi-plugins/persistence/locations.ts (skillsStagingDir + skillsTargetDir from Plan 03-01)
    - extensions/pi-plugins/shared/vars.ts (substituteClaudeVars from Plan 03-01)
    - extensions/pi-plugins/shared/fs-utils.ts (cleanupStaging from Plan 03-01)
    - extensions/pi-plugins/shared/errors.ts (appendLeakToError)
    - extensions/pi-plugins/shared/path-safety.ts (assertPathInside)
    - extensions/pi-plugins/domain/name.ts (assertSafeName + generatedSkillName from Phase 2 + B-02 label arg from Plan 03-01)
    - extensions/pi-plugins/domain/resolver.ts (ResolvedPluginInstallable from Phase 2)
  provides:
...
key-files:
  created:
    - extensions/pi-plugins/bridges/skills/types.ts
    - extensions/pi-plugins/bridges/skills/discover.ts
    - extensions/pi-plugins/bridges/skills/rewrite-frontmatter.ts
    - extensions/pi-plugins/bridges/skills/stage.ts
    - extensions/pi-plugins/bridges/skills/unstage.ts
    - extensions/pi-plugins/bridges/skills/index.ts
...
**`extensions/pi-plugins/bridges/skills/types.ts`** -- type contracts for the bridge.
...
**`extensions/pi-plugins/bridges/skills/discover.ts`** -- SK-5 enumeration.
...
**`extensions/pi-plugins/bridges/skills/rewrite-frontmatter.ts`** -- SK-3 carry-forward.
...
**`extensions/pi-plugins/bridges/skills/stage.ts`** -- prepare/commit/abort + collision check.
...
**`extensions/pi-plugins/bridges/skills/unstage.ts`** -- post-install removal.
...
**`extensions/pi-plugins/bridges/skills/index.ts`** -- public-surface barrel.
...
- **Files modified:** `extensions/pi-plugins/bridges/skills/discover.ts`.
...
- **Files modified:** `extensions/pi-plugins/bridges/skills/unstage.ts`.
...
- **Files modified:** `extensions/pi-plugins/bridges/skills/discover.ts`, `tests/bridges/skills/discover.test.ts`.
- **Commit:** `35cb069`.
...
- **Files modified:** `extensions/pi-plugins/bridges/skills/unstage.ts`, `tests/bridges/skills/stage.test.ts`.
- **Commit:** `3668453`.
...
- All created files exist on disk:
  - `extensions/pi-plugins/bridges/skills/types.ts` -- FOUND
  - `extensions/pi-plugins/bridges/skills/discover.ts` -- FOUND
  - `extensions/pi-plugins/bridges/skills/rewrite-frontmatter.ts` -- FOUND
  - `extensions/pi-plugins/bridges/skills/stage.ts` -- FOUND
  - `extensions/pi-plugins/bridges/skills/unstage.ts` -- FOUND
  - `extensions/pi-plugins/bridges/skills/index.ts` -- FOUND
