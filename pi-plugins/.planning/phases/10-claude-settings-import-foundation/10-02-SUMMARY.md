...
- `extensions/pi-plugins/orchestrators/import/refs.ts` - Parser and enabled-plugin extraction logic.
- `extensions/pi-plugins/orchestrators/import/types.ts` - Enabled ref and extraction result types.
- `extensions/pi-plugins/orchestrators/import/index.ts` - Public exports for parser/extractor.
