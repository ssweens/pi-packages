...
key-files:
  created:
    - extensions/pi-plugins/orchestrators/import/marketplaces.ts
    - tests/orchestrators/import/marketplaces.test.ts
  modified:
    - extensions/pi-plugins/orchestrators/import/types.ts
    - extensions/pi-plugins/orchestrators/import/index.ts
    - extensions/pi-plugins/orchestrators/import/settings.ts
    - extensions/pi-plugins/orchestrators/import/refs.ts
...
- `extensions/pi-plugins/orchestrators/import/marketplaces.ts` - Marketplace source mapping and per-scope import plan builder.
- `extensions/pi-plugins/orchestrators/import/types.ts` - Planned marketplace/plugin/skipped/import-plan types.
- `extensions/pi-plugins/orchestrators/import/index.ts` - Public Phase 10 planner exports.
- `extensions/pi-plugins/orchestrators/import/settings.ts` - Formatted by Prettier during final validation.
- `extensions/pi-plugins/orchestrators/import/refs.ts` - Formatted by Prettier during final validation.
