...
must_haves:
  ...
  key_links:
    - from: tests/edge/args.test.ts
      ...
      via: "import { parseArgs } from \"../../extensions/pi-plugins/edge/args.ts\""
      pattern: "import.*edge/args"
    - from: tests/shared/completion-cache.test.ts
      to: extensions/pi-plugins/shared/completion-cache.ts
      via: "import * as cache from \"../../extensions/pi-plugins/shared/completion-cache.ts\""
...
import * as _target from "../../extensions/pi-plugins/edge/args.ts";
...
**tests/edge/args.test.ts** -- target `extensions/pi-plugins/edge/args.ts`. One `test.skip` per case (use these exact names):
...
**tests/edge/args-schema.test.ts** -- target `extensions/pi-plugins/edge/args-schema.ts`. Cases:
...
**tests/edge/router.test.ts** -- target `extensions/pi-plugins/edge/router.ts`. Cases:
...
**tests/edge/completions/normalize.test.ts** -- target `extensions/pi-plugins/edge/completions/normalize.ts`. Cases:
...
**tests/edge/completions/provider.test.ts** -- target `extensions/pi-plugins/edge/completions/provider.ts`. One `test.skip` per case:
...
**tests/edge/completions/data.test.ts** -- target `extensions/pi-plugins/edge/completions/data.ts`. Cases:
...
**tests/shared/completion-cache.test.ts** -- target `extensions/pi-plugins/shared/completion-cache.ts`. Cases:
...
**tests/edge/handlers/plugin/install.test.ts** -- target `extensions/pi-plugins/edge/handlers/plugin/install.ts`. Cases:
...
**tests/edge/handlers/plugin/update.test.ts** -- target `extensions/pi-plugins/edge/handlers/plugin/update.ts`. Cases:
...
**tests/edge/handlers/plugin/list.test.ts** -- target `extensions/pi-plugins/edge/handlers/plugin/list.ts`. Cases:
...
**tests/edge/handlers/marketplace/add.test.ts** -- target `extensions/pi-plugins/edge/handlers/marketplace/add.ts`. Cases:
...
**tests/edge/handlers/marketplace/remove.test.ts** -- target `extensions/pi-plugins/edge/handlers/marketplace/remove.ts`. Cases:
...
**tests/edge/handlers/marketplace/list.test.ts** -- target `extensions/pi-plugins/edge/handlers/marketplace/list.ts`. Cases:
...
**tests/edge/handlers/marketplace/update.test.ts** -- target `extensions/pi-plugins/edge/handlers/marketplace/update.ts`. Cases:
...
**tests/edge/handlers/marketplace/autoupdate.test.ts** -- target `extensions/pi-plugins/edge/handlers/marketplace/autoupdate.ts`. Cases:
...
**tests/edge/handlers/tools.test.ts** -- target `extensions/pi-plugins/edge/handlers/tools.ts`. Cases:
- "D-02 :: registerListMarketplacesTool registers tool name pi_plugins_list with empty params schema"
- "D-02 :: registerListPluginsTool registers tool name pi_plugins_plugin_list with extended params"
- "pi_plugins_list :: empty state returns content text \"No marketplaces configured.\" + details.marketplaces == []"
- "pi_plugins_list :: populated state returns one line per marketplace formatted [<scope>] <name> -- <N> plugin(s) -- <source.logical>"
- "pi_plugins_plugin_list :: marketplace set, marketplace exists -> plugins from that marketplace"
- "pi_plugins_plugin_list :: marketplace set, marketplace not found -> error text + details.plugins == []"
- "pi_plugins_plugin_list :: marketplace omitted -> enumerate across all marketplaces"
- "pi_plugins_plugin_list :: installed: true filter -> only installed bucket"
- "pi_plugins_plugin_list :: available: true filter -> only available bucket"
- "pi_plugins_plugin_list :: unavailable: true filter -> only unavailable bucket"
- "pi_plugins_plugin_list :: available: true + unavailable: true -> union of both (PL-1)"
- "pi_plugins_plugin_list :: no filters -> all three buckets (PL-1 default)"
- "pi_plugins_plugin_list :: scope: \"user\" filters to user scope only"
- "pi_plugins_plugin_list :: scope: \"project\" filters to project scope only"

**tests/edge/register.test.ts** -- target `extensions/pi-plugins/edge/register.ts`. Cases:
...
- "D-04 :: registerClaudeMarketplaceTools registers pi_plugins_list"
- "D-04 :: registerClaudeMarketplaceTools registers pi_plugins_plugin_list"
