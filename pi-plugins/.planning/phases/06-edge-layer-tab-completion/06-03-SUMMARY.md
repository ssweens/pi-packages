...
- **Files affected:** `extensions/pi-plugins/edge/completions/data.ts`, `extensions/pi-plugins/edge/completions/provider.ts`.
...
- **Files affected:** `extensions/pi-plugins/shared/completion-cache.ts`.
- **Verification:** `npx tsc --noEmit` -> 0 errors.
...
- extensions/pi-plugins/shared/completion-cache.ts -- FOUND
- extensions/pi-plugins/edge/completions/data.ts -- FOUND
- extensions/pi-plugins/edge/completions/provider.ts -- FOUND
