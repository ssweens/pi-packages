...
key-files:
  created:
    - extensions/pi-plugins/orchestrators/plugin/shared.ts
...
- `extensions/pi-plugins/orchestrators/plugin/shared.ts` -- new file. Exports `CrossPluginGeneratedNames` interface and `assertNoCrossPluginConflicts(scope, generatedNames, state): void`. 118 lines including header banner + JSDoc.
...
- **Files modified:** extensions/pi-plugins/orchestrators/plugin/shared.ts; tests/orchestrators/plugin/shared.test.ts
