...
- **Post-success plugin data cleanup:** delete the per-plugin data directory only after successful replacement (`.planning/PROJECT.md:25,46`). Cleanup failure should likely be warning-grade and retryable, analogous to uninstall data-dir cleanup (`docs/prd/pi-plugins-prd.md:267-270`).
